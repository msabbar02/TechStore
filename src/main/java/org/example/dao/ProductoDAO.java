...
public class ProductoDAO {
    ...
    public static final Map<Integer, Producto> PRODUCTOS_CACHE = new ConcurrentHashMap<>(100);
    public static final Map<Integer, Long> CACHE_TIMESTAMP = new ConcurrentHashMap<>(100);
