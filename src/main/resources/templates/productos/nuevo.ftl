...
<@layout.layout title="Nuevo Producto - TechStore" showNavbar=false>
    <style>
        .header-simple {
            display: flex;
    ...
    <div class="form-container">
        ...
        <form action="/productos/crear" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea id="descripcion" name="descripcion" class="form-input form-textarea" required></textarea>
            </div>
        
            <div class="form-group">
                <label for="precio" class="form-label">Precio*</label>
                <input type="number" id="precio" name="precio" step="0.01" min="0" class="form-input" required>
            ...
            <div class="form-group">
                ...
                <span class="form-hint">Formatos aceptados: JPG, PNG, GIF. Tamaño máximo: 5MB</span>
                
                <div class="preview-container">
                    <img id="imgPreview" class="img-preview" alt="Vista previa de la imagen">
                </div>
            </div>

            <div class="form-actions">
                <button type="submit" class="btn btn-primary" style="width: 100%;">
                    <i class="fas fa-save" style="margin-right: 0.5rem;"></i> Guardar Producto
                </button>
            </div>
        </form>
    </div>
